...
def _handle_all_gather(qt, args, kwargs):
    ...
    gathered_bytes = torch.ops._c10d_functional.all_gather_into_tensor.default(*new_args, **kwargs)
...
def _handle_fp8_split(qt, args, kwargs):
    ...
    wrapped_chunks = tuple(_wrap_fp8_tensor(input_tensor, chunk) for chunk in qdata_chunks)
