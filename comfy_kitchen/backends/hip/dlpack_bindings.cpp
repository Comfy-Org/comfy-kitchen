...
// Maps a DLPack dtype onto
// comfy_kitchen.backends.eager.quantization.DTYPE_TO_CODE: 0=float32,
// 1=float16, 2=bfloat16, 3=uint8, 4=int8.
//
...
// name, so an fp8 tensor would land in the -1 branch. The Python layer
// therefore hands fp8 across as uint8 and passes the fp8 code alongside it as
// an int.
  ...
  if (dtype.code == static_cast<uint8_t>(nb::dlpack::dtype_code::Float)) {
    ...
    if (dtype.bits == 16)
      return 1;
                 ...
                 static_cast<uint8_t>(nb::dlpack::dtype_code::Bfloat) &&
             dtype.bits == 16) {
    return 2;
  } else if (dtype.code == static_cast<uint8_t>(nb::dlpack::dtype_code::UInt) &&
             dtype.bits == 8) {
    return 3;
  } else if (dtype.code == static_cast<uint8_t>(nb::dlpack::dtype_code::Int) &&
             dtype.bits == 8) {
    return 4;
  }
  return -1;
...
extern "C" {
void launch_quantize_per_tensor_fp8_kernel(const void *, const void *, void *,
                                           int64_t, int, int, hipStream_t);
void launch_dequantize_per_tensor_fp8_kernel(const void *, const void *, void *,
                                             int64_t, int, int, hipStream_t);
void launch_stochastic_round_fp8_kernel(void *, const void *, int64_t, int, int,
                                        int, hipStream_t);

void launch_scaled_mm_fp8_kernel(const void *, const void *, void *,
                                 const void *, const void *, const void *, int,
                                 int, int, int, int, hipStream_t);
void launch_convrot_w4a4_gemm_kernel(const void *, const void *, void *,
                                     const void *, const void *, const void *,
                                     int, int, int, int, int, hipStream_t);
bool launch_fp16_gemm_kernel(const void *, const void *, void *, const void *,
                             const void *, const void *, int, int, int,
                             hipStream_t);
bool launch_fp16_conv3d_kernel(const void *, const void *, const void *,
                               const void *, void *, int, int, int, int, int,
                               int, int, int, int, int, int, int, int, int, int,
                               hipStream_t);

void launch_quantize_int8_rowwise_kernel(const void *, int, void *, void *, int,
                                         int, hipStream_t);
void launch_quantize_int8_convrot_kernel(const void *, int, void *, void *,
                                         void *, void *, int, int, int, int,
                                         const void *, float, hipStream_t);
void launch_quantize_int8_tensorwise_kernel(const void *, int, void *, void *,
                                            void *, int64_t, hipStream_t);
void launch_dequantize_int8_simple_kernel(const void *, const void *, void *,
                                          int64_t, int64_t, int, int,
                                          hipStream_t);
void launch_dequantize_int8_convrot_weight_kernel(const void *, const void *,
                                                  void *, int, int, int, int,
                                                  int, hipStream_t);
void launch_convrot_quant_int4_kernel(const void *, int, void *, void *, int,
                                      int, int, hipStream_t);
...
void launch_quantize_w4a8_convrot_kernel(const void *, const void *, void *,
                                         void *, void *, int64_t, int64_t, int,
                                         bool, uint64_t, hipStream_t);
bool launch_w4a8_codebook_gemv_kernel(const void *xq, const void *qw,
                                      const void *s_rel, const void *codebook,
                                      const void *s_channel, const void *xs,
                                      const void *bias, int bias_code,
                                      void *out, int out_code, int M, int N,
...
bool launch_gated_delta_decode_fused_kernel(
    ...
    const void *dt_bias, const void *g_decay, void *state, void *out,
    void *snapshots, const void *z, const void *norm_w, float eps, int B,
    int Hv, int Hk, int S, int DK, int DV, int C, int Hd, int key_dim,
    float scale, int dtype_code, hipStream_t stream);
bool launch_deltanet_conv_step_kernel(const void *proj, void *conv_state,
                                      const void *conv_w, const void *conv_b,
                                      void *conv_out, void *conv_snaps, int B,
                                      int C, int S, int KS, int dtype_code,
                                      hipStream_t stream);
int w4a8_requant_max_k_kernel();
void launch_na3d_kernel(const void *, const void *, const void *, void *, int,
...
void launch_adaln_kernel(const void *, const void *, const void *, void *, int,
                         ...
                         hipStream_t);
void launch_group_norm_silu_pad3d(const void *, const void *, const void *,
                                  void *, void *, int, int, int, int, int, int,
                                  float, int, int, int, int, int, bool, int,
                                  hipStream_t);
void launch_gemv_awq_kernel(const void *, const void *, const void *,
                            const void *, const void *, void *, int, int, int,
                            int, int, int, int, int, hipStream_t);
void launch_svdquant_lora_down_kernel(const void *, const void *, void *, int,
                                      int, int, int, int, hipStream_t);
void launch_svdquant_quant_kernel(const void *, const void *, void *, void *,
                                  int, int, int, int, int, bool, hipStream_t);
void launch_svdquant_gemm_kernel(const void *, const void *, void *,
                                 const void *, const void *, const void *,
                                 const void *, const void *, int, int, int, int,
                                 int, int, int, int, int, int, bool,
                                 hipStream_t);
void launch_apply_rope_kernel(const void *, const void *, const void *, void *,
                              void *, int64_t, int64_t, int64_t, int64_t,
                              int64_t, int64_t, int64_t, int64_t, int64_t,
                              int64_t, int64_t, int64_t, int64_t, int64_t,
                              int64_t, int64_t, int64_t, int64_t, int64_t,
                              int64_t, int64_t, int, int, bool, hipStream_t);
void launch_rms_rope_kernel(const void *, const void *, const void *,
                            const void *, const void *, void *, void *, int64_t,
                            int64_t, int64_t, int64_t, int64_t, int64_t,
                            int64_t, int64_t, int64_t, int64_t, int64_t,
                            int64_t, int64_t, int64_t, int64_t, int64_t,
                            int64_t, int64_t, int64_t, int64_t, int64_t,
                            int64_t, int, int, int, float, bool, hipStream_t);
}

static void check_hip_launch() {
  hipError_t err = hipGetLastError();
  if (err != hipSuccess) {
    throw std::runtime_error(std::string("HIP kernel launch failed: ") +
...
// the wrong dtype, is an out-of-bounds device access rather than an exception.
// The epilogues cast the scales to raw float32 and index scale_a[row] up to M
// and scale_b[col * stride] up to N, so a short or wrongly-typed scale is an
// out-of-bounds device read rather than an exception.
static void require_scale_len(const nb::ndarray<> &s, size_t need,
  ...
  if (s.size() < need) {
    throw std::runtime_error(
        std::string(fn) + ": " + name + " has " + std::to_string(s.size()) +
        " elements, needs at least " + std::to_string(need));
  }
}
...
// Every kernel takes raw pointers plus caller-supplied extents and indexes up
// to those extents with no bounds of its own, so a tensor smaller than the
// extents it is launched with is an out-of-bounds device access. _C is
// importable, so these are checked here rather than trusted from the Python
// layer.
static void require_len(const nb::ndarray<> &t, int64_t need, const char *fn,
                        const char *name) {
  if (need < 0 || t.size() < static_cast<size_t>(need)) {
    throw std::runtime_error(
        std::string(fn) + ": " + name + " has " + std::to_string(t.size()) +
        " elements, needs at least " + std::to_string(need));
  }
}

// lo..hi are DTYPE_TO_CODE values: 0..2 float32/16/bfloat16, 3 uint8, 4 int8.
static void require_dtype(const nb::ndarray<> &t, int lo, int hi,
                          const char *fn, const char *name) {
...
// negative one (M*K stays positive), then reaches a launcher where it becomes
// an enormous unsigned grid. Reject each extent on its own before any product.
static void require_nonneg(int v, const char *fn, const char *name) {
  if (v < 0) {
    throw std::runtime_error(std::string(fn) + ": " + name +
                             " must be non-negative, got " + std::to_string(v));
  }
}
...
static void require_out_matches(const nb::ndarray<> &c, int out_code,
                                const char *fn) {
  if (out_code != map_dtype_to_code(c.dtype())) {
    throw std::runtime_error(std::string(fn) +
                             ": out_code does not match the output dtype");
  }
}
...
static void require_bias(const OptArray &bias, int n, const char *fn) {
  ...
  if (bias->size() < static_cast<size_t>(n)) {
    throw std::runtime_error(std::string(fn) + ": bias has " +
                             std::to_string(bias->size()) +
                             " elements, needs at least " + std::to_string(n));
  }
}

static void require_numel(int64_t numel, const nb::ndarray<> &t, const char *fn,
                          const char *name) {
  if (numel < 0 || static_cast<size_t>(numel) > t.size()) {
    throw std::runtime_error(
        std::string(fn) + ": numel=" + std::to_string(numel) + " exceeds " +
        name + " (" + std::to_string(t.size()) + " elements)");
  }
}
...
static void require_code(int code, int lo, int hi, const char *fn,
                         const char *name) {
  if (code < lo || code > hi) {
    throw std::runtime_error(std::string(fn) + ": unsupported " + name +
...
void quantize_per_tensor_fp8(nb::ndarray<> input, nb::ndarray<> scale,
  ...
  if (map_dtype_to_code(input.dtype()) != input_dtype_code) {
    throw std::runtime_error(std::string(kFn) +
                             ": input dtype does not match its code");
  }
  // fp8 crosses as uint8; the output buffer must be that storage (as in
  // scaled_mm_fp8).
  ...
  launch_quantize_per_tensor_fp8_kernel(
      input.data(), scale.data(), output.data(), numel, input_dtype_code,
      output_dtype_code, reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}
...
void dequantize_per_tensor_fp8(nb::ndarray<> input, nb::ndarray<> scale,
  ...
  if (map_dtype_to_code(output.dtype()) != output_dtype_code) {
    throw std::runtime_error(std::string(kFn) +
                             ": output dtype does not match its code");
  }
  // fp8 crosses as uint8; the input buffer must be that storage (as in
  // scaled_mm_fp8).
...
void scaled_mm_fp8(nb::ndarray<> a, nb::ndarray<> b, nb::ndarray<> c,
                   nb::ndarray<> scale_a, nb::ndarray<> scale_b, OptArray bias,
...
void int8_gemm(nb::ndarray<> a, nb::ndarray<> b, nb::ndarray<> c,
               nb::ndarray<> scale_a, nb::ndarray<> scale_b, int scale_b_stride,
               OptArray bias, int M, int N, int K, int out_code,
               uintptr_t stream_ptr) {
  ...
  if (scale_b_stride != 0 && scale_b_stride != 1) {
    throw std::runtime_error(std::string(kFn) +
                             ": scale_b_stride must be 0 or 1, got " +
...
void convrot_w4a4_gemm(nb::ndarray<> a, nb::ndarray<> b, nb::ndarray<> c,
                       nb::ndarray<> x_scale, nb::ndarray<> w_scale,
                       OptArray bias, int M, int N, int K, int out_code,
                       uintptr_t stream_ptr) {
  ...
  if (K % 2 != 0) {
    throw std::runtime_error(std::string(kFn) + ": K must be even, got " +
                             std::to_string(K));
  }
  require_dtype(a, 4, 4, kFn, "a");
  require_dtype(b, 4, 4, kFn, "b");
  ...
  require_len(c, static_cast<int64_t>(M) * N, kFn, "c");
  // EpiRowwise with a stride of 1: per-row activation scale, per-column weight
  // scale.
...
static void require_fp16(const nb::ndarray<> &t, const char *fn,
                         const char *name) {
  require_dtype(t, 1, 1, fn, name);
}

// D = A @ B^T + bias, or resid + rscale * (that). Every operand is fp16; false
// means the caller serves the shape.
bool fp16_gemm(nb::ndarray<> a, nb::ndarray<> b, nb::ndarray<> d, OptArray bias,
               OptArray rscale, OptArray resid, int M, int N, int K,
               uintptr_t stream_ptr) {
  ...
  if (rscale.has_value() != resid.has_value()) {
    throw std::runtime_error(std::string(kFn) +
                             ": rscale and resid must be given together");
  }
  if (resid.has_value()) {
...
// NDHWC conv3d, zero padding, x [N, D, H, W, C] and w [K, T, R, S, C] fp16 in
// that memory order; out and resid are [N, Z, P, Q, K]. false means the caller
// serves it.
bool fp16_conv3d(nb::ndarray<> x, nb::ndarray<> w, OptArray bias,
                 OptArray resid, nb::ndarray<> out, int N, int D, int H, int W,
                 int C, int K, int T, int R, int S, int sd, int sh, int sw,
                 uintptr_t stream_ptr) {
  ...
  const bool served = launch_fp16_conv3d_kernel(
      x.data(), w.data(), opt_data(bias), opt_data(resid), out.data(), N, D, H,
      W, C, K, T, R, S, Z, P, Q, sd, sh, sw,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
  return served;
}

// The int4 quantizers pack two nibbles per byte, so the packed row is K / 2
// bytes and an odd K would round it down and drop the tail.
static void require_convrot_group(int k, int group_size, const char *fn) {
  // A negative K divisible by group_size would clear the divisibility check
  // below, and with M=0 the length products collapse to zero, so it would
  // otherwise reach the launcher as a negative extent.
  require_nonneg(k, fn, "K");
  if (group_size != 16 && group_size != 64 && group_size != 256) {
    throw std::runtime_error(std::string(fn) +
                             ": group_size must be 16, 64 or 256, got " +
                             std::to_string(group_size));
  }
  if (k % group_size != 0) {
    throw std::runtime_error(
        std::string(fn) + ": K=" + std::to_string(k) +
        " is not divisible by group_size=" + std::to_string(group_size));
  }
}

void quantize_int8_rowwise(nb::ndarray<> x, nb::ndarray<> q,
                           nb::ndarray<> scales, int M, int K,
                           uintptr_t stream_ptr) {
  ...
  launch_quantize_int8_rowwise_kernel(
      x.data(), map_dtype_to_code(x.dtype()), q.data(), scales.data(), M, K,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}

// act_code folds an activation into the rotation's load. rms_norm (code 3)
// reads a K-element act_weight in x's dtype and act_eps.
void quantize_int8_convrot(nb::ndarray<> x, nb::ndarray<> q,
                           nb::ndarray<> scales, OptArray spill_rotated,
                           OptArray spill_partials, int M, int K,
                           int group_size, int act_code, uintptr_t stream_ptr,
                           OptArray act_weight = std::nullopt,
                           float act_eps = 0.0f) {
  ...
  if (spill_rotated.has_value()) {
    ...
    require_len(*spill_rotated, static_cast<int64_t>(M) * K, kFn,
                "spill_rotated");
    if (map_dtype_to_code(spill_rotated->dtype()) !=
        map_dtype_to_code(x.dtype())) {
      throw std::runtime_error(std::string(kFn) +
                               ": spill_rotated dtype must match x");
    }
    spill_rotated_ptr = spill_rotated->data();
  }
  if (spill_partials.has_value()) {
    require_dtype(*spill_partials, 0, 0, kFn, "spill_partials");
    require_len(*spill_partials, static_cast<int64_t>(M) * (K / 256), kFn,
                "spill_partials");
  ...
  if (act_code == 3) {
    if (!act_weight.has_value()) {
      throw std::runtime_error(std::string(kFn) +
                               ": rms_norm requires act_weight");
    }
    if (map_dtype_to_code(act_weight->dtype()) !=
        map_dtype_to_code(x.dtype())) {
      throw std::runtime_error(std::string(kFn) +
                               ": act_weight dtype must match x");
    }
    require_len(*act_weight, K, kFn, "act_weight");
  }

  launch_quantize_int8_convrot_kernel(
      x.data(), map_dtype_to_code(x.dtype()), q.data(), scales.data(),
      spill_rotated_ptr, spill_partials_ptr, M, K, group_size, act_code,
      act_code == 3 ? act_weight->data() : nullptr, act_eps,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}

void quantize_int8_tensorwise(nb::ndarray<> x, nb::ndarray<> q,
                              nb::ndarray<> scale, nb::ndarray<> scratch,
  ...
  // to be a single 4-byte element, and the kernel atomicMaxes into it, so it
  // must start at zero rather than carry a stale absmax from the caller's
  // buffer.
  require_len(scratch, 1, kFn, "scratch");
  if (scratch.dtype().bits != 32) {
    throw std::runtime_error(std::string(kFn) +
                             ": scratch must be a 32-bit element");
  }
  auto stream = reinterpret_cast<hipStream_t>(stream_ptr);
  if (hipMemsetAsync(scratch.data(), 0, sizeof(unsigned int), stream) !=
      hipSuccess) {
    throw std::runtime_error(std::string(kFn) + ": failed to clear scratch");
  }

  launch_quantize_int8_tensorwise_kernel(x.data(), map_dtype_to_code(x.dtype()),
                                         q.data(), scale.data(), scratch.data(),
                                         numel, stream);
  check_hip_launch();
}

void dequantize_int8_simple(nb::ndarray<> q, nb::ndarray<> scale,
                            nb::ndarray<> out, int64_t inner_dim,
  ...
  if (numel > 0) {
    ...
    if (scale_mode == 1) {
      ...
      if (numel % inner_dim != 0) {
        throw std::runtime_error(std::string(kFn) +
                                 ": numel must be divisible by inner_dim");
      }
...
void dequantize_int8_convrot_weight(nb::ndarray<> q, nb::ndarray<> scale,
                                    nb::ndarray<> out, int M, int K,
  ...
  if (scale.size() != 1 && scale.size() != static_cast<size_t>(M)) {
    throw std::runtime_error(
        std::string(kFn) +
        ": scale must contain one value or one value per row");
  }
...
void convrot_quant_int4(nb::ndarray<> x, nb::ndarray<> q, nb::ndarray<> scales,
  ...
  launch_convrot_quant_int4_kernel(x.data(), map_dtype_to_code(x.dtype()),
                                   q.data(), scales.data(), M, K, group_size,
                                   reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}

void unpack_int4(nb::ndarray<> q, nb::ndarray<> out, int64_t nbytes,
                 uintptr_t stream_ptr) {
...
void quantize_w4a8_convrot(nb::ndarray<> rotated, nb::ndarray<> codebook,
                           nb::ndarray<> packed, nb::ndarray<> s_rel,
                           nb::ndarray<> s_channel, int N, int K,
  ...
  launch_quantize_w4a8_convrot_kernel(
      rotated.data(), codebook.data(), packed.data(), s_rel.data(),
...
void dequant_int4_grouped_to_int8(nb::ndarray<> qdata, nb::ndarray<> s_rel,
                                  int scale_code, OptArray codebook,
                                  nb::ndarray<> out, int N, int K,
                                  int group_size, uintptr_t stream_ptr) {
  ...
  if (scale_code != 0 && scale_code != 5) {
    throw std::runtime_error(std::string(kFn) +
                             ": s_rel must be float32 or float8_e4m3fn");
  }
  if (K % group_size != 0) {
...
// Chunked W4A8: decode chunk_cols weight columns at a time and run the INT8
// GEMM on each chunk, writing an N-wide slice of out. xq/xs are the already
// rotated and quantized activation, so the loop only touches the weight.
void w4a8_int8_gemm_chunked(nb::ndarray<> xq, nb::ndarray<> qdata,
                            nb::ndarray<> s_rel, int scale_code,
                            OptArray codebook, nb::ndarray<> s_channel,
                            nb::ndarray<> xs, OptArray bias,
                            nb::ndarray<> workspace, nb::ndarray<> out, int M,
                            int N, int K, int group_size, int chunk_cols,
  ...
  // Every chunk decodes into the same scratch, so it has to hold the widest
  // one.
  require_len(workspace,
              static_cast<int64_t>(chunk_cols < N ? chunk_cols : N) * K, kFn,
              "workspace");
  require_scale_len(s_channel, static_cast<size_t>(N), kFn, "s_channel");
...
// Decode W4A8: one wave per output column dequantizes the INT4 weight in
// registers and dots it against the INT8 activation, with no workspace in
// between. Returns false when the shape is outside its envelope so the caller
// runs the chunked path instead; the two agree bit for bit where both apply.
bool w4a8_codebook_gemv(nb::ndarray<> xq, nb::ndarray<> qdata,
                        nb::ndarray<> s_rel, OptArray codebook,
                        nb::ndarray<> s_channel, nb::ndarray<> xs,
                        OptArray bias, nb::ndarray<> out, int M, int N, int K,
                        int group_size, int out_code, uintptr_t stream_ptr) {
  ...
  const bool used = launch_w4a8_codebook_gemv_kernel(
      xq.data(), qdata.data(), s_rel.data(), opt_data(codebook),
      s_channel.data(), xs.data(), opt_data(bias), opt_code(bias), out.data(),
      out_code, M, N, K, group_size, reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
  return used;
}
...
static void adaln_impl(const char *kFn, nb::ndarray<> &x, nb::ndarray<> &scale,
                       nb::ndarray<> &shift, nb::ndarray<> &out, int N, int D,
                       int scale_group, int shift_group, float eps,
                       bool subtract_mean, uintptr_t stream_ptr) {
  require_nonneg(N, kFn, "N");
  ...
  if (map_dtype_to_code(out.dtype()) != map_dtype_to_code(x.dtype())) {
    throw std::runtime_error(std::string(kFn) +
                             ": out must have the same dtype as x");
  }
  ...
  // the caller derives from it are 0, so only constrain them when there are
  // rows.
  if (N > 0 && D > 0) {
    require_positive(scale_group, kFn, "scale_group");
    require_positive(shift_group, kFn, "shift_group");
    require_len(scale, (static_cast<int64_t>(N - 1) / scale_group + 1) * D, kFn,
                "scale");
    require_len(shift, (static_cast<int64_t>(N - 1) / shift_group + 1) * D, kFn,
                "shift");
  }

  launch_adaln_kernel(
      x.data(), scale.data(), shift.data(), out.data(), N, D, scale_group,
...
// Per-frame GroupNorm + SiLU + causal conv padding over NDHWC storage. weight
// and bias absent -> pad only, and the workspace is not read.
void group_norm_silu_pad3d(nb::ndarray<> x, OptArray weight, OptArray bias,
                           nb::ndarray<> out, OptArray workspace, int B, int C,
                           int T, int H, int W, int num_groups, float eps,
  ...
  if (weight.has_value() != bias.has_value()) {
    throw std::runtime_error(std::string(kFn) +
                             ": weight and bias must be given together");
  }
  if (weight.has_value()) {
...
// Fused 3D neighborhood attention. Every extent is caller-supplied and the
// kernel indexes up to it, so the operands are sized here rather than trusted.
void na3d(nb::ndarray<> q, nb::ndarray<> k, nb::ndarray<> v, nb::ndarray<> out,
          int batch, int t_size, int h_size, int w_size, int num_heads,
          int head_dim, int kt, int kh, int kw, int causal_t, int causal_h,
          int causal_w, float scale, int dtype_code, uintptr_t stream_ptr) {
  ...
  const int64_t need = static_cast<int64_t>(batch) * t_size * h_size * w_size *
                       num_heads * head_dim;
  ...
  launch_na3d_kernel(q.data(), k.data(), v.data(), out.data(), batch, t_size,
                     h_size, w_size, num_heads, head_dim, kt, kh, kw, causal_t,
                     causal_h, causal_w, scale, dtype_code,
                     reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}

void adaln(nb::ndarray<> x, nb::ndarray<> scale, nb::ndarray<> shift,
           nb::ndarray<> out, int N, int D, int scale_group, int shift_group,
...
void rms_adaln(nb::ndarray<> x, nb::ndarray<> scale, nb::ndarray<> shift,
               nb::ndarray<> out, int N, int D, int scale_group,
               int shift_group, float eps, uintptr_t stream_ptr) {
  adaln_impl("rms_adaln", x, scale, shift, out, N, D, scale_group, shift_group,
             eps,
...
// place rather than being recomputed on the Python side. Shared by apply_rope
// and rms_rope, which index both tensors the same way. rot_dim is the rotated
// head-dim prefix; 0 rotates everything.
static int64_t require_rope_shapes(const nb::ndarray<> &x,
                                   const nb::ndarray<> &freqs, const char *fn,
                                   int64_t rot_dim = 0) {
  ...
  if (x.ndim() != 4)
    throw std::runtime_error(std::string(fn) + " expects a 4D input");
  if (freqs.ndim() != 6)
    throw std::runtime_error(std::string(fn) + " expects a 6D freqs_cis");

  // Only the rotated prefix is paired, so an odd head_dim is fine as long as
  // the resolved rot is even: the leftover tail is norm-only. apply_rope stays
  ...
  if (rot % 2 != 0 || rot > head_dim) {
    throw std::runtime_error(std::string(fn) +
                             " expects an even rot_dim <= head_dim");
  }

  // The kernel indexes freqs as (fb, fd1, fd2, rot_dim/2, 2, 2), broadcasting a
  // leading dim only when it is 1. Anything else walks off the end of the
  // array.
  if (freqs.shape(3) != static_cast<size_t>(rot / 2) || freqs.shape(4) != 2 ||
      freqs.shape(5) != 2) {
    throw std::runtime_error(
        std::string(fn) + " expects freqs_cis trailing dims (rot_dim/2, 2, 2)");
  }
...
// An output is walked with its own strides, so it only has to match the
// extents.
static void require_rope_extents(const nb::ndarray<> &x, const nb::ndarray<> &t,
...
static void require_rope_layout(const nb::ndarray<> &x, const nb::ndarray<> &t,
                                const char *name, const char *fn) {
...
void apply_rope(nb::ndarray<> xq, OptArray xk, nb::ndarray<> freqs,
                nb::ndarray<> xq_out, OptArray xk_out, bool split_half,
                uintptr_t stream_ptr) {
  ...
  if (xk.has_value() != xk_out.has_value()) {
    throw std::runtime_error(
        "apply_rope expects xk and xk_out together or not at all");
  }
  ...
  launch_apply_rope_kernel(
      xq.data(), xk.has_value() ? xk->data() : nullptr, freqs.data(),
      xq_out.data(), xk_out.has_value() ? xk_out->data() : nullptr,
      ...
      static_cast<int64_t>(freqs.shape(0)),
      static_cast<int64_t>(freqs.shape(1)),
      static_cast<int64_t>(freqs.shape(2)), static_cast<int64_t>(xq.stride(0)),
      static_cast<int64_t>(xq.stride(1)), static_cast<int64_t>(xq.stride(2)),
      static_cast<int64_t>(xq.stride(3)),
      static_cast<int64_t>(xq_out.stride(0)),
      static_cast<int64_t>(xq_out.stride(1)),
      static_cast<int64_t>(xq_out.stride(2)),
      static_cast<int64_t>(xq_out.stride(3)),
      static_cast<int64_t>(freqs.stride(0)),
      static_cast<int64_t>(freqs.stride(1)),
      static_cast<int64_t>(freqs.stride(2)),
      static_cast<int64_t>(freqs.stride(3)),
      static_cast<int64_t>(freqs.stride(4)),
      static_cast<int64_t>(freqs.stride(5)), map_dtype_to_code(xq.dtype()),
      map_dtype_to_code(freqs.dtype()), split_half,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}
...
void rms_rope(nb::ndarray<> q, OptArray k, nb::ndarray<> freqs,
              nb::ndarray<> q_scale, OptArray k_scale, nb::ndarray<> q_out,
              OptArray k_out, float epsilon, bool split_half,
              uintptr_t stream_ptr, int64_t rot_dim) {
  ...
  if (k.has_value() != k_out.has_value() ||
      k.has_value() != k_scale.has_value()) {
    throw std::runtime_error(
        "rms_rope expects k, k_scale and k_out together or not at all");
  }
  ...
  if (k_scale.has_value()) {
    if (k_scale->dtype() != q_scale.dtype()) {
      throw std::runtime_error(
          "rms_rope expects k_scale to have q_scale's dtype");
    }
    require_len(*k_scale, head_dim, kFn, "k_scale");
  }

  launch_rms_rope_kernel(
      q.data(), k.has_value() ? k->data() : nullptr, freqs.data(),
      q_scale.data(), k_scale.has_value() ? k_scale->data() : nullptr,
      q_out.data(), k_out.has_value() ? k_out->data() : nullptr,
      static_cast<int64_t>(q.shape(0)), static_cast<int64_t>(q.shape(1)),
      static_cast<int64_t>(q.shape(2)), head_dim, rot,
      static_cast<int64_t>(freqs.shape(0)),
      static_cast<int64_t>(freqs.shape(1)),
      static_cast<int64_t>(freqs.shape(2)), static_cast<int64_t>(q.stride(0)),
      static_cast<int64_t>(q.stride(1)), static_cast<int64_t>(q.stride(2)),
      static_cast<int64_t>(q.stride(3)), static_cast<int64_t>(q_out.stride(0)),
      static_cast<int64_t>(q_out.stride(1)),
      static_cast<int64_t>(q_out.stride(2)),
      static_cast<int64_t>(q_out.stride(3)),
      static_cast<int64_t>(freqs.stride(0)),
      static_cast<int64_t>(freqs.stride(1)),
      static_cast<int64_t>(freqs.stride(2)),
      static_cast<int64_t>(freqs.stride(3)),
      static_cast<int64_t>(freqs.stride(4)),
      static_cast<int64_t>(freqs.stride(5)), map_dtype_to_code(q.dtype()),
      map_dtype_to_code(freqs.dtype()), map_dtype_to_code(q_scale.dtype()),
      epsilon, split_half, reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}

void gemv_awq_w4a16(nb::ndarray<> x, nb::ndarray<> qweight,
                    nb::ndarray<> wscales, nb::ndarray<> wzeros, OptArray bias,
                    nb::ndarray<> out, int M, int N, int K, int group_size,
                    uintptr_t stream_ptr) {
  constexpr const char *kFn = "gemv_awq_w4a16";
  require_nonneg(M, kFn, "M");
  require_nonneg(N, kFn, "N");
  require_nonneg(K, kFn, "K");
  // The launcher enforces the packing invariants (group_size a positive
  // multiple of 8, K a multiple of both 8 and group_size); these are the
  // operand extents.
  require_dtype(x, 0, 2, kFn, "x");
  ...
  // Only wscales' dtype code reaches the kernel; it decodes wzeros with the
  // same code, so a differing wzeros dtype would be misread.
  if (map_dtype_to_code(wzeros.dtype()) != map_dtype_to_code(wscales.dtype())) {
    throw std::runtime_error(std::string(kFn) +
                             ": wzeros must have the same dtype as wscales");
  }
  require_len(x, static_cast<int64_t>(M) * K, kFn, "x");
  require_len(out, static_cast<int64_t>(M) * N, kFn, "out");
  ...
  launch_gemv_awq_kernel(x.data(), qweight.data(), wscales.data(),
                         wzeros.data(), opt_data(bias), out.data(), M, N, K,
                         group_size, map_dtype_to_code(x.dtype()),
...
void svdquant_lora_down(nb::ndarray<> x, nb::ndarray<> lora_down,
                        nb::ndarray<> lora_act, int M, int K, int R,
                        uintptr_t stream_ptr) {
  ...
  // The launcher writes lora_act through a float*, so it must be float32
  // storage.
  ...
  launch_svdquant_lora_down_kernel(x.data(), lora_down.data(), lora_act.data(),
                                   M, K, R, map_dtype_to_code(x.dtype()),
...
void svdquant_quantize(nb::ndarray<> x, nb::ndarray<> smooth, nb::ndarray<> q,
                       nb::ndarray<> ascales, int M, int M_pad, int K,
  ...
  // The launcher passes only ascales' dtype code; the kernel decodes smooth
  // with it too, so a differing smooth dtype would be misread.
  if (map_dtype_to_code(smooth.dtype()) != map_dtype_to_code(ascales.dtype())) {
    throw std::runtime_error(std::string(kFn) +
                             ": smooth must have the same dtype as ascales");
  }
  require_len(x, static_cast<int64_t>(M) * K, kFn, "x");
  ...
  require_len(ascales, (static_cast<int64_t>(K) / kSvdGroup) * M_pad, kFn,
              "ascales");

  launch_svdquant_quant_kernel(
      x.data(), smooth.data(), q.data(), ascales.data(), M, M_pad, K,
      map_dtype_to_code(x.dtype()), map_dtype_to_code(ascales.dtype()),
      act_unsigned, reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}

void svdquant_gemm(nb::ndarray<> a, nb::ndarray<> b, nb::ndarray<> c,
                   nb::ndarray<> ascales, nb::ndarray<> wscales,
                   nb::ndarray<> lora_act, nb::ndarray<> lora_up, OptArray bias,
                   int M, int N, int K, int R, bool act_unsigned,
                   uintptr_t stream_ptr) {
  ...
  launch_svdquant_gemm_kernel(
      a.data(), b.data(), c.data(), ascales.data(), wscales.data(),
      lora_act.data(), lora_up.data(), opt_data(bias), M, N, K, R,
      map_dtype_to_code(ascales.dtype()), map_dtype_to_code(wscales.dtype()),
      map_dtype_to_code(lora_act.dtype()), map_dtype_to_code(lora_up.dtype()),
      opt_code(bias), map_dtype_to_code(c.dtype()), act_unsigned,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}
...
// INT8 attention
//
// Buffer shapes differ from the CUDA backend because the scale granularity
// does; see sage_attention/quant_qk_int8.hip. _C is importable on its own, so
// every extent the kernels index off a raw pointer is checked here rather than
// trusted from the Python layer.
// ---------------------------------------------------------------------------
...
static int sage_padded_q(int qo_len) {
  return ((qo_len + kSageCtaQ - 1) / kSageCtaQ) * kSageCtaQ;
}

static int sage_padded_k(int kv_len, int cta_k) {
  return ((kv_len + cta_k - 1) / cta_k) * cta_k;
}
...
static void sage_check_shapes(const nb::ndarray<> &q, const nb::ndarray<> &k,
  ...
  if (q.ndim() != 4 || k.ndim() != 4 || v.ndim() != 4) {
    throw std::runtime_error(std::string(fn) +
                             ": q, k and v must be 4D [B, H, L, D]");
  }
  const int head_dim = static_cast<int>(q.shape(3));
  if (head_dim != 64 && head_dim != 128 && head_dim != 256) {
    throw std::runtime_error(std::string(fn) +
                             ": head_dim must be 64, 128 or 256, got " +
                             std::to_string(head_dim));
  }
  if (k.shape(0) != q.shape(0) || v.shape(0) != q.shape(0) ||
      v.shape(1) != k.shape(1) || v.shape(2) != k.shape(2) ||
      k.shape(3) != q.shape(3) || v.shape(3) != q.shape(3)) {
    throw std::runtime_error(std::string(fn) +
  ...
  if (q.shape(0) == 0 || q.shape(1) == 0 || k.shape(1) == 0 ||
      q.shape(2) == 0 || k.shape(2) == 0) {
    throw std::runtime_error(
        std::string(fn) +
        ": batch, head counts and sequence lengths must be positive");
  }
...
// Kernels that synthesize strides from extents instead of reading tensor
// strides require packed row-major operands, including views passed directly to
// _C.
static void require_packed_contiguous(const nb::ndarray<> &t, const char *fn,
                                      const char *name) {
  int64_t expected = 1;
...
static void
sage_check_quantized(const nb::ndarray<> &q_int8, const nb::ndarray<> &q_scale,
                     const nb::ndarray<> &k_int8, const nb::ndarray<> &k_scale,
                     const nb::ndarray<> &v_int8, const nb::ndarray<> &v_scale,
                     int batch, int q_heads, int kv_heads, int qo_len,
                     int kv_len, int head_dim, int cta_k, const char *fn) {
  ...
  require_len(q_int8, static_cast<int64_t>(batch) * q_heads * qo_len * head_dim,
              fn, "q_int8");
  require_len(k_int8,
              static_cast<int64_t>(batch) * kv_heads * kv_len * head_dim, fn,
              "k_int8");
  require_len(v_int8,
              static_cast<int64_t>(batch) * kv_heads * head_dim * padded_k, fn,
              "v_int8");
  require_scale_len(q_scale, static_cast<size_t>(batch) * q_heads * padded_q,
                    fn, "q_scale");
  require_scale_len(k_scale,
                    static_cast<size_t>(batch) * kv_heads *
                        (padded_k / kSageKeyGroup),
                    fn, "k_scale");
  require_scale_len(v_scale, static_cast<size_t>(batch) * kv_heads * head_dim,
                    fn, "v_scale");
...
static void
sage_quantize(const nb::ndarray<> &q, const nb::ndarray<> &k,
              const nb::ndarray<> &v, const nb::ndarray<> &q_int8,
              const nb::ndarray<> &q_scale, const nb::ndarray<> &k_int8,
              const nb::ndarray<> &k_scale, const nb::ndarray<> &v_int8,
              const nb::ndarray<> &v_scale, const nb::ndarray<> &anchor_indices,
              int input_dtype_code, int cta_k, hipStream_t stream,
              const char *fn) {
  ...
  if (input_dtype_code < 0 || input_dtype_code > 2) {
    throw std::runtime_error(
        std::string(fn) + ": input dtype must be float32, float16 or bfloat16");
  }
  ...
  sage_check_quantized(q_int8, q_scale, k_int8, k_scale, v_int8, v_scale, batch,
                       q_heads, kv_heads, qo_len, kv_len, head_dim, cta_k, fn);
  ...
  if (anchor_indices.dtype().bits != 32) {
    throw std::runtime_error(std::string(fn) +
                             ": anchor_indices must be a 32-bit element");
  }
  require_len(anchor_indices, static_cast<int64_t>(batch) * kv_heads, fn,
              "anchor_indices");

  launch_sage_quant_qk_int8(
      q.data(), q_int8.data(), q_scale.data(), k.data(), k_int8.data(),
      k_scale.data(), anchor_indices.data(), batch, q_heads, qo_len,
      sage_padded_q(qo_len), kv_heads, kv_len, padded_k / kSageKeyGroup,
      head_dim, q.stride(0), q.stride(1), q.stride(2), k.stride(0), k.stride(1),
      k.stride(2), input_dtype_code, sage_rotation(kv_len, head_dim), stream);

  launch_sage_quant_v_int8(v.data(), v_int8.data(), v_scale.data(), batch,
                           kv_heads, kv_len, head_dim, padded_k, v.stride(0),
...
static void sage_mask_info(const OptArray &attn_mask, int batch, int q_heads,
                           int qo_len, int kv_len, const void *&ptr,
                           int64_t &stride_b, int64_t &stride_h,
                           int64_t &stride_q, int64_t &stride_k,
                           int &dtype_code, const char *fn) {
  ptr = nullptr;
  ...
  if (mask.ndim() != 4 || static_cast<int>(mask.shape(0)) != batch ||
      static_cast<int>(mask.shape(1)) != q_heads ||
      static_cast<int>(mask.shape(2)) != qo_len ||
...
static void
sage_attend(const nb::ndarray<> &q_int8, const nb::ndarray<> &k_int8,
            ...
            int cta_k, float sm_scale, int output_dtype_code,
            hipStream_t stream, const char *fn) {
  if (output_dtype_code != 1 && output_dtype_code != 2) {
    throw std::runtime_error(std::string(fn) +
                             ": output dtype must be float16 or bfloat16");
  }
  require_dtype(o, output_dtype_code, output_dtype_code, fn, "o");
  require_len(o, static_cast<int64_t>(batch) * q_heads * qo_len * head_dim, fn,
              "o");
  ...
  if (o.ndim() != 4 || static_cast<int>(o.shape(0)) != batch ||
      static_cast<int>(o.shape(1)) != q_heads ||
      static_cast<int>(o.shape(2)) != qo_len ||
  ...
  int mask_dtype_code;
  sage_mask_info(attn_mask, batch, q_heads, qo_len, kv_len, mask_ptr,
                 mask_stride_b, mask_stride_h, mask_stride_q, mask_stride_k,
                 mask_dtype_code, fn);

  const int padded_k = sage_padded_k(kv_len, cta_k);
  launch_sage_int8_attn(q_int8.data(), k_int8.data(), v_int8.data(), o.data(),
                        q_scale.data(), k_scale.data(), v_scale.data(),
                        mask_ptr, mask_stride_b, mask_stride_h, mask_stride_q,
                        mask_stride_k, mask_dtype_code, cta_k, batch, qo_len,
                        kv_len, sage_padded_q(qo_len), q_heads, kv_heads,
                        head_dim, padded_k / kSageKeyGroup,
                        ...
                        static_cast<int64_t>(q_heads) * qo_len * head_dim,
                        static_cast<int64_t>(qo_len) * head_dim, head_dim,
...
// Python layer.
void sage_sdpa(nb::ndarray<> q, nb::ndarray<> k, nb::ndarray<> v,
               nb::ndarray<> o, nb::ndarray<> q_int8, nb::ndarray<> q_scale,
               nb::ndarray<> k_int8, nb::ndarray<> k_scale,
               nb::ndarray<> v_int8, nb::ndarray<> v_scale,
               nb::ndarray<> anchor_indices, float sm_scale, int cta_k,
  ...
  sage_quantize(q, k, v, q_int8, q_scale, k_int8, k_scale, v_int8, v_scale,
                anchor_indices, input_dtype_code, cta_k, stream, kFn);
  check_hip_launch();
  sage_attend(q_int8, k_int8, v_int8, o, q_scale, k_scale, v_scale, attn_mask,
              batch, q_heads, kv_heads, qo_len, kv_len, head_dim, cta_k,
              sm_scale, output_dtype_code, stream, kFn);
}
...
void sage_sdpa_quantize(nb::ndarray<> q, nb::ndarray<> k, nb::ndarray<> v,
                        nb::ndarray<> q_int8, nb::ndarray<> q_scale,
                        nb::ndarray<> k_int8, nb::ndarray<> k_scale,
                        nb::ndarray<> v_int8, nb::ndarray<> v_scale,
  ...
  sage_check_cta_k(cta_k, kFn);
  sage_quantize(q, k, v, q_int8, q_scale, k_int8, k_scale, v_int8, v_scale,
                anchor_indices, input_dtype_code, cta_k,
...
void sage_sdpa_prequantized(nb::ndarray<> q_int8, nb::ndarray<> k_int8,
                            nb::ndarray<> v_int8, nb::ndarray<> o,
                            nb::ndarray<> q_scale, nb::ndarray<> k_scale,
  ...
  if (batch == 0 || q_heads == 0 || kv_heads == 0 || qo_len == 0 ||
      kv_len == 0) {
    throw std::runtime_error(
        std::string(kFn) +
        ": batch, head counts and sequence lengths must be positive");
  ...
  if (static_cast<int>(k_int8.shape(0)) != batch ||
      static_cast<int>(k_int8.shape(3)) != head_dim ||
      q_heads % kv_heads != 0) {
    throw std::runtime_error(std::string(kFn) +
                             ": incompatible quantized tensor shapes");
  }
  sage_check_quantized(q_int8, q_scale, k_int8, k_scale, v_int8, v_scale, batch,
                       q_heads, kv_heads, qo_len, kv_len, head_dim, cta_k, kFn);
  // V is packed as [B * H_kv * D, padded_k], and padded_k follows cta_k.
  // Element count alone cannot tell a buffer packed against a different cta_k
  // from a correct one, and the kernel would read shifted rows rather than
  // fail.
...
void flash_attention_decode(nb::ndarray<> q, nb::ndarray<> k, nb::ndarray<> v,
                            ...
                            nb::ndarray<> softmax_lse,
                            nb::ndarray<> softmax_lse_accum,
  ...
  if (map_dtype_to_code(kv_lengths.dtype()) != -1 ||
      kv_lengths.dtype().code !=
          static_cast<uint8_t>(nb::dlpack::dtype_code::Int) ||
  ...
  if (k.stride(0) != v.stride(0) || k.stride(1) != v.stride(1) ||
      k.stride(2) != v.stride(2) || k.stride(3) != 1 || v.stride(3) != 1 ||
  ...
  if (output.stride(0) != q.stride(0) || output.stride(1) != q.stride(1)) {
    throw std::runtime_error(std::string(kFn) +
                             ": output strides must match q");
  }
  // Rows are read four elements at a time, so every row start has to stay on
  // that boundary.
  const int64_t vectored[] = {q.stride(0), q.stride(1), k.stride(0),
  ...
  if (num_splits > 1 && (softmax_lse_accum.device_type() != kDeviceRocm ||
  ...
  launch_flash_decode(
      q.data(), k.data(), v.data(), static_cast<const int *>(kv_lengths.data()),
...
// ---------------------------------------------------------------------------
//
// _C is importable, so none of this can assume the Python layer put it
// together. The kernels reach q/k/v and the workspace as bare pointers sized
// from (B, T, H), so a short buffer, or a layout the 16-byte staging loads
// cannot use, is an out-of-bounds device access rather than an exception.

// The kernels read these as packed arrays of one dtype, so an element count on
// its own is not enough: a narrower dtype makes the buffer shorter in bytes
// than the kernel reads, and a strided view of the right count is accessed as
// though it were packed. `code` is a DTYPE_TO_CODE value.
static void sol_need_elems(const nb::ndarray<> &a, int64_t n, int code,
...
// Extents size every workspace slot and every grid, and they reach the kernels
// as plain ints. A non-positive one plans a workspace nothing checks again.
static void sol_need_extents(int64_t batch, int64_t seq_len, int64_t num_heads,
                             const char *fn) {
...
// routing kernel emit that many extra list entries, wrapped to huge uint16
// block ids, and overrun the per-query row.
static void sol_need_sinks(int64_t start, int64_t end, const char *fn,
                           const char *what) {
...
static void sol_check_block_len(const nb::ndarray<> &b, int64_t seq_len,
                                const char *fn) {
  if (b.dtype().code != static_cast<uint8_t>(nb::dlpack::dtype_code::Int) ||
    ...
    throw std::runtime_error(
        std::string(fn) + ": block_len must be a contiguous 1-D int32 array of "
                          "ceil(T/64) elements");
  }
}

static void sol_need_workspace(const nb::ndarray<> &ws, int64_t batch,
                               int64_t seq_len, int64_t num_heads,
                               int64_t token_aug, const char *fn) {
  int64_t v[48];
  const int n = sol_attn_plan(
      static_cast<int>(batch), static_cast<int>(seq_len),
      static_cast<int>(num_heads), static_cast<int>(token_aug), v, 48);
  if (n > 48 ||
      static_cast<int64_t>(ws.size()) < v[n - 1]) { // last slot is "total"
    throw std::runtime_error(std::string(fn) +
                             ": workspace too small for this shape");
  }
  // sol_attn_plan reports byte offsets and the Python layer slices the
  // workspace with them to read the block means back out, so a workspace of
  // anything but bytes reads the wrong slots. The size check above already
  // bounds the allocation, since no element is narrower than a byte; this pins
  // the units.
  if (map_dtype_to_code(ws.dtype()) != 3) {
    throw std::runtime_error(std::string(fn) +
                             ": workspace must be a uint8 array");
  }
}

// q/k/v/out element code for launch_sol_attn: 0 = bfloat16, 1 = float16, -1 =
// neither
static int sol_elem_code(const nb::ndarray<> &a) {
  const int code = map_dtype_to_code(a.dtype());
  return code == 2 ? 0 : code == 1 ? 1 : -1;
}
static void sol_need_bthd(const nb::ndarray<> &a, int64_t b, int64_t t,
                          int64_t h, int64_t d, int elem, const char *fn,
                          const char *what) {
  if (a.ndim() != 4 || sol_elem_code(a) != elem ||
      a.shape(0) != static_cast<size_t>(b) ||
      a.shape(1) != static_cast<size_t>(t) ||
      a.shape(2) != static_cast<size_t>(h) ||
      a.shape(3) != static_cast<size_t>(d)) {
    throw std::runtime_error(
        std::string(fn) + ": " + what +
...
// The kernels stage rows with 16-byte loads: unit last stride, 16-byte base,
// and leading strides (of non-singleton dims) that keep every row 16-byte
// aligned.
static void sol_need_staging_layout(const nb::ndarray<> &a, const char *fn,
                                    const char *what) {
  bool ok = a.stride(3) == 1 && reinterpret_cast<uintptr_t>(a.data()) % 16 == 0;
  for (int i = 0; i < 3; ++i)
    ok = ok && (a.shape(i) <= 1 || a.stride(i) % 8 == 0);
  if (!ok) {
    throw std::runtime_error(std::string(fn) + ": " + what +
                             " must have a contiguous last dim, a 16-byte "
                             "aligned base and leading strides that "
                             "are multiples of 8");
  }
}

static void sol_need_contiguous(const nb::ndarray<> &a, const char *fn,
                                const char *what) {
  int64_t expect = 1;
  for (int i = static_cast<int>(a.ndim()) - 1; i >= 0; --i) {
    if (a.shape(i) > 1 && a.stride(i) != expect) {
...
nb::dict sol_attn_plan_py(int64_t batch, int64_t seq_len, int64_t num_heads,
  ...
  if (n > 48)
    throw std::runtime_error(
        "sol_attn_plan: Plan grew past the binding's buffer");
  nb::dict d;
  for (int i = 0; i < n && sol_attn_plan_names[i]; ++i)
    d[sol_attn_plan_names[i]] = v[i];
  return d;
}

void sol_attn(nb::ndarray<> q, nb::ndarray<> k, nb::ndarray<> v,
              nb::ndarray<> out, nb::ndarray<> workspace, int64_t batch,
              int64_t seq_len, int64_t num_heads, int64_t head_dim, float tau,
              float scale, int64_t sink_start, int64_t sink_end,
              int64_t sink_q_start, int64_t sink_q_end, uintptr_t stream_ptr,
              OptArray key_bias = std::nullopt,
              OptArray threshold = std::nullopt,
  ...
  if (threshold) {
    sol_need_elems(*threshold, batch * num_heads * ((seq_len + 63) / 64), 0,
                   kFn, "threshold");
  }
  if (block_len)
    sol_check_block_len(*block_len, seq_len, kFn);
  const int elem = sol_elem_code(q);
  if (elem < 0)
    throw std::runtime_error(std::string(kFn) +
                             ": q must be bfloat16 or float16");
  ...
  if (key_bias)
    sol_need_elems(*key_bias, batch * seq_len, 0, kFn, "key_bias");
  // Explicit strides: only the last dim must be contiguous (BHND views go in
  // as-is).
  launch_sol_attn(q.data(), k.data(), v.data(), out.data(), workspace.data(),
                  static_cast<int>(batch), static_cast<int>(seq_len),
                  static_cast<int>(num_heads), static_cast<int>(head_dim), elem,
                  tau, scale, opt_data(key_bias), opt_data(threshold),
                  opt_data(block_len), tail ? 1 : 0,
                  ...
                  k.stride(1), k.stride(2), v.stride(0), v.stride(1),
                  v.stride(2), static_cast<int>(token_aug), stream);
  check_hip_launch();
}

void sol_producer_begin_py(nb::ndarray<> workspace, int64_t batch,
                           int64_t seq_len, int64_t num_heads,
                           uintptr_t stream_ptr, int64_t token_aug = 0) {
  sol_need_extents(batch, seq_len, num_heads, "sol_producer_begin");
  sol_need_workspace(workspace, batch, seq_len, num_heads, token_aug,
                     "sol_producer_begin");
  sol_producer_begin(workspace.data(), static_cast<int>(batch),
...
void sol_producer_chunk_py(nb::ndarray<> workspace, nb::ndarray<> qkv,
                           nb::ndarray<> fab, nb::ndarray<> qw,
                           nb::ndarray<> kw, nb::ndarray<> kmean,
                           nb::ndarray<> vscale, float rope_eps,
                           int64_t rot_dim, int64_t t0, int64_t m,
                           int64_t batch, int64_t seq_len, int64_t num_heads,
                           uintptr_t stream_ptr,
                           OptArray block_len = std::nullopt,
                           int64_t token_aug = 0) {
  constexpr const char *kFn = "sol_producer_chunk";
  sol_need_extents(batch, seq_len, num_heads, kFn);
  if (batch != 1)
    throw std::runtime_error(std::string(kFn) +
                             ": the producer path is B=1 only");
  ...
  if (t0 < 0 || m < 0 || t0 + m > seq_len || (m && t0 % 64)) {
    throw std::runtime_error(std::string(kFn) +
                             ": chunk [t0, t0 + m) must lie in [0, seq_len] "
                             "with a 64-aligned start");
  }
  if (block_len)
    sol_check_block_len(*block_len, seq_len, kFn);
  sol_need_workspace(workspace, batch, seq_len, num_heads, token_aug, kFn);
  ...
  sol_producer_chunk(workspace.data(), qkv.data(), fab.data(), qw.data(),
                     ...
                     opt_data(block_len), rope_eps, static_cast<int>(rot_dim),
                     static_cast<int>(t0), static_cast<int>(m),
                     static_cast<int>(batch), static_cast<int>(seq_len),
...
void sol_attn_core_py(nb::ndarray<> workspace, nb::ndarray<> out,
                      nb::ndarray<> vscale, nb::ndarray<> kmean_next,
                      nb::ndarray<> vamax_out, int64_t batch, int64_t seq_len,
                      int64_t num_heads, float tau, float scale,
                      int64_t sink_start, int64_t sink_end,
                      int64_t sink_q_start, int64_t sink_q_end,
                      uintptr_t stream_ptr, OptArray threshold = std::nullopt,
                      OptArray block_len = std::nullopt, bool tail = true,
                      int64_t token_aug = 0) {
  ...
  launch_sol_attn_core(
      workspace.data(), out.data(), vscale.data(), kmean_next.data(),
      vamax_out.data(), opt_data(block_len), tail ? 1 : 0,
      static_cast<int>(batch), static_cast<int>(seq_len),
      static_cast<int>(num_heads), tau, scale, opt_data(threshold),
      static_cast<int>(sink_start), static_cast<int>(sink_end),
      static_cast<int>(sink_q_start), static_cast<int>(sink_q_end),
      static_cast<int>(token_aug), reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
}
...
static void require_same_dtype(const nb::ndarray<> &t, int dtype_code,
                               const char *fn, const char *name) {
...
// GatedDeltaNet decode: S <= 8 steps of the delta rule for one (batch, value
// head) per block, with the gate projections, q/k normalization and the gated
// RMSNorm folded in. state is updated in place; snapshots, when given, records
// it after steps 0..S-2 for the speculative-decode rollback.
bool gated_delta_decode_fused(nb::ndarray<> mixed_qkv, nb::ndarray<> x,
                              nb::ndarray<> w_a, nb::ndarray<> w_b,
                              nb::ndarray<> dt_bias, nb::ndarray<> g_decay,
                              nb::ndarray<> state, nb::ndarray<> out,
                              OptArray snapshots, nb::ndarray<> z,
                              nb::ndarray<> norm_w, double eps, int B, int Hv,
                              int Hk, int S, int DK, int DV, int C, int Hd,
                              int key_dim, double scale, uintptr_t stream_ptr) {
  ...
  if (C < 2 * key_dim + Hv * DV) {
    throw std::runtime_error(std::string(kFn) +
                             ": C is too small for 2 * key_dim + Hv * DV");
  }
  ...
  if (snapshots.has_value() && S > 1) {
    require_scale_len(*snapshots, static_cast<size_t>(S - 1) * B * Hv * DK * DV,
                      kFn, "snapshots");
  ...
  const bool used = launch_gated_delta_decode_fused_kernel(
      mixed_qkv.data(), x.data(), w_a.data(), w_b.data(), dt_bias.data(),
      g_decay.data(), state.data(), out.data(), snap_ptr, z.data(),
      norm_w.data(), static_cast<float>(eps), B, Hv, Hk, S, DK, DV, C, Hd,
      key_dim, static_cast<float>(scale), dtype_code,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
  return used;
}

// Depthwise causal conv decode step with silu. conv_state is updated in place
// and conv_snaps, when given, records it after steps 0..S-2.
bool deltanet_conv_step(nb::ndarray<> proj, nb::ndarray<> conv_state,
                        nb::ndarray<> conv_w, OptArray conv_b,
                        nb::ndarray<> conv_out, OptArray conv_snaps, int B,
  ...
  require_len(conv_state, static_cast<int64_t>(B) * C * (KS - 1), kFn,
              "conv_state");
  ...
  if (conv_snaps.has_value() && S > 1) {
    ...
    require_len(*conv_snaps, static_cast<int64_t>(S - 1) * B * C * (KS - 1),
                kFn, "conv_snaps");
  ...
  const bool used = launch_deltanet_conv_step_kernel(
      proj.data(), conv_state.data(), conv_w.data(), opt_data(conv_b),
      conv_out.data(), snaps, B, C, S, KS, dtype_code,
      reinterpret_cast<hipStream_t>(stream_ptr));
  check_hip_launch();
  return used;
}
...
NB_MODULE(_C, m) {
  m.doc() = "ComfyKitchen HIP backend native operations (RDNA2-RDNA4, WMMA on "
            "gfx11/gfx12)";
  m.def("sol_attn_plan", &sol_attn_plan_py,
        "Workspace dims, slot byte offsets and total bytes for this shape and "
        "token budget",
        nb::arg("batch"), nb::arg("seq_len"), nb::arg("num_heads"),
        nb::arg("token_aug") = 0);
  m.def("sol_attn", &sol_attn,
        "Sol-Attn training-free sparse attention (BF16 or FP16 in/out, "
        "head_dim 128)",
        nb::arg("q"), nb::arg("k"), nb::arg("v"), nb::arg("out"),
        nb::arg("workspace"), nb::arg("batch"), nb::arg("seq_len"),
        nb::arg("num_heads"), nb::arg("head_dim"), nb::arg("tau"),
        nb::arg("scale"), nb::arg("sink_start"), nb::arg("sink_end"),
        ...
        nb::arg("token_aug") = 0);
  m.def("sol_producer_begin", &sol_producer_begin_py, nb::arg("workspace"),
        nb::arg("batch"), nb::arg("seq_len"), nb::arg("num_heads"),
        nb::arg("stream_ptr"), nb::arg("token_aug") = 0);
  m.def("sol_producer_chunk", &sol_producer_chunk_py, nb::arg("workspace"),
        nb::arg("qkv"), nb::arg("fab"), nb::arg("qw"), nb::arg("kw"),
        nb::arg("kmean"), nb::arg("vscale"), nb::arg("rope_eps"),
        nb::arg("rot_dim"), nb::arg("t0"), nb::arg("m"), nb::arg("batch"),
        nb::arg("seq_len"), nb::arg("num_heads"), nb::arg("stream_ptr"),
        nb::arg("block_len") = nb::none(), nb::arg("token_aug") = 0);
  m.def("sol_attn_core", &sol_attn_core_py, nb::arg("workspace"),
        nb::arg("out"), nb::arg("vscale"), nb::arg("kmean_next"),
        nb::arg("vamax_out"), nb::arg("batch"), nb::arg("seq_len"),
        nb::arg("num_heads"), nb::arg("tau"), nb::arg("scale"),
        nb::arg("sink_start"), nb::arg("sink_end"), nb::arg("sink_q_start"),
        nb::arg("sink_q_end"), nb::arg("stream_ptr"),
  ...
  m.def("fp16_gemm", &fp16_gemm, nb::arg("a"), nb::arg("b"), nb::arg("d"),
        nb::arg("bias").none(), nb::arg("rscale").none(),
        nb::arg("resid").none(), nb::arg("M"), nb::arg("N"), nb::arg("K"),
        nb::arg("stream_ptr"));
  m.def("fp16_conv3d", &fp16_conv3d, nb::arg("x"), nb::arg("w"),
        nb::arg("bias").none(), nb::arg("resid").none(), nb::arg("out"),
        nb::arg("N"), nb::arg("D"), nb::arg("H"), nb::arg("W"), nb::arg("C"),
        nb::arg("K"), nb::arg("T"), nb::arg("R"), nb::arg("S"), nb::arg("sd"),
        nb::arg("sh"), nb::arg("sw"), nb::arg("stream_ptr"));
  m.def("quantize_int8_rowwise", &quantize_int8_rowwise);
  m.def("quantize_int8_convrot", &quantize_int8_convrot, nb::arg("x"),
        nb::arg("q"), nb::arg("scales"), nb::arg("spill_rotated").none(),
        nb::arg("spill_partials").none(), nb::arg("M"), nb::arg("K"),
        nb::arg("group_size"), nb::arg("act_code"), nb::arg("stream_ptr"),
        nb::arg("act_weight") = nb::none(), nb::arg("act_eps") = 0.0f);
  ...
  m.def("convrot_int8_needs_spill", &convrot_int8_needs_spill_host,
        nb::arg("m"), nb::arg("k"), nb::arg("in_code"));
  ...
  m.def("gated_delta_decode_fused", &gated_delta_decode_fused,
        nb::arg("mixed_qkv"), nb::arg("x"), nb::arg("w_a"), nb::arg("w_b"),
        nb::arg("dt_bias"), nb::arg("g_decay"), nb::arg("state"),
        nb::arg("out"), nb::arg("snapshots").none(), nb::arg("z"),
        nb::arg("norm_w"), nb::arg("eps"), nb::arg("B"), nb::arg("Hv"),
        nb::arg("Hk"), nb::arg("S"), nb::arg("DK"), nb::arg("DV"), nb::arg("C"),
        nb::arg("Hd"), nb::arg("key_dim"), nb::arg("scale"),
        nb::arg("stream_ptr"));
  m.def("deltanet_conv_step", &deltanet_conv_step, nb::arg("proj"),
        nb::arg("conv_state"), nb::arg("conv_w"), nb::arg("conv_b").none(),
        nb::arg("conv_out"), nb::arg("conv_snaps").none(), nb::arg("B"),
        nb::arg("C"), nb::arg("S"), nb::arg("KS"), nb::arg("stream_ptr"));
  m.def("na3d", &na3d);
  m.def("flash_attention_decode", &flash_attention_decode, nb::arg("q"),
        nb::arg("k"), nb::arg("v"), nb::arg("kv_lengths"), nb::arg("output"),
        nb::arg("softmax_lse"), nb::arg("softmax_lse_accum"),
        nb::arg("output_accum"), nb::arg("num_splits"), nb::arg("stream_ptr"));
  m.def("sage_sdpa", &sage_sdpa, nb::arg("q"), nb::arg("k"), nb::arg("v"),
        nb::arg("o"), nb::arg("q_int8"), nb::arg("q_scale"), nb::arg("k_int8"),
        nb::arg("k_scale"), nb::arg("v_int8"), nb::arg("v_scale"),
        nb::arg("anchor_indices"), nb::arg("sm_scale"), nb::arg("cta_k"),
        nb::arg("input_dtype_code"), nb::arg("output_dtype_code"),
        nb::arg("stream_ptr"), nb::arg("attn_mask") = nb::none());
  m.def("sage_sdpa_quantize", &sage_sdpa_quantize, nb::arg("q"), nb::arg("k"),
        nb::arg("v"), nb::arg("q_int8"), nb::arg("q_scale"), nb::arg("k_int8"),
        nb::arg("k_scale"), nb::arg("v_int8"), nb::arg("v_scale"),
        nb::arg("anchor_indices"), nb::arg("cta_k"),
        nb::arg("input_dtype_code"), nb::arg("stream_ptr"));
  m.def("sage_sdpa_prequantized", &sage_sdpa_prequantized, nb::arg("q_int8"),
        nb::arg("k_int8"), nb::arg("v_int8"), nb::arg("o"), nb::arg("q_scale"),
        nb::arg("k_scale"), nb::arg("v_scale"), nb::arg("cta_k"),
        nb::arg("sm_scale"), nb::arg("output_dtype_code"),
        nb::arg("stream_ptr"), nb::arg("attn_mask") = nb::none());
  m.def("adaln", &adaln);
  m.def("rms_adaln", &rms_adaln);
  m.def("group_norm_silu_pad3d", &group_norm_silu_pad3d, nb::arg("x"),
        nb::arg("weight").none(), nb::arg("bias").none(), nb::arg("out"),
        nb::arg("workspace").none(), nb::arg("B"), nb::arg("C"), nb::arg("T"),
        nb::arg("H"), nb::arg("W"), nb::arg("num_groups"), nb::arg("eps"),
