...
unpack_half2_from_uint32_to_float(float *dest, uint32_t source) {
...
__device__ __forceinline__ void
floatx4_to_e4m3x4(uint32_t *dest, float *source0, float *source1) {
...
__device__ __forceinline__ void
floatx4_to_e5m2x4(uint32_t *dest, float *source0, float *source1) {
#ifdef FP8_CAST_ENABLED
  asm volatile("{\n"
               ".reg .b16 lo;\n"
               ".reg .b16 hi;\n"
...
__device__ __forceinline__ void
halfx4_to_e4m3x4(uint32_t *dest, uint32_t *source0, uint32_t *source1) {
#ifdef FP8_CAST_ENABLED
  asm volatile("{\n"
               ".reg .b16 lo;\n"
               ".reg .b16 hi;\n"
...
__device__ __forceinline__ void
halfx4_to_e5m2x4(uint32_t *dest, uint32_t *source0, uint32_t *source1) {
#ifdef FP8_CAST_ENABLED
  asm volatile("{\n"
               ".reg .b16 lo;\n"
               ".reg .b16 hi;\n"
...
__device__ __forceinline__ void
e4m3x4_to_halfx4(uint32_t *dest0, uint32_t *dest1, uint32_t *source) {
#ifdef FP8_CAST_ENABLED
  asm volatile("{\n"
               ".reg .b16 lo, hi;\n"
               "mov.b32 {lo, hi}, %2;\n"
...
__device__ __forceinline__ void
e5m2x4_to_halfx4(uint32_t *dest0, uint32_t *dest1, uint32_t *source) {
#ifdef FP8_CAST_ENABLED
  asm volatile("{\n"
               ".reg .b16 lo, hi;\n"
               "mov.b32 {lo, hi}, %2;\n"
