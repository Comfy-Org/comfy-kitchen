...
inline bool is_supported_raw_bhsd_view(const anemoi_native::Tensor& tensor) {
...
inline bool is_supported_raw_bhsd_input_view(const anemoi_native::Tensor& tensor) {
