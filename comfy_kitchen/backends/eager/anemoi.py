...
"""Anemoi full-precision reference, routing reference, and custom-op boundary.
...
from ...anemoi import materialize_layout, resolve_options
...
def route_probability(
    ...
    *,
    ...
    return AnemoiRoute(ids.contiguous(), *counts)


@torch.library.custom_op("comfy_kitchen::anemoi_attention", mutates_args=())
def _op_anemoi_attention(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    ...
    implementation = registry.get_implementation("anemoi_attention", kwargs=kwargs)
    return implementation(**kwargs)


@_op_anemoi_attention.register_fake
def _op_anemoi_attention_fake(
    q,
    k,
    v,
    video_shape,
